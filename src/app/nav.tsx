...
export default function Nav() {
    return (
        <nav className="shadow-md shadow-slate-950 flex justify-between items-center top-0 z-10 py-4 px-8 mr-4 w-full fixed h-fit bg-gradient-to-t from-transparent to-[#1d1e22]/[0.4]">
            <div className="container flex justify-between">
                ...
                {/* <form>
                    <div className="flex items-center bg-[#34363e] rounded-full shadow-sm">
                        <input
                            type="text"
                            placeholder="Search through my photos"
